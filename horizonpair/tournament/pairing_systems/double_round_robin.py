#  double_round_robin is a part of HorizonPair
...
class DoubleRoundRobin(PairingSystem):
    """The Double Round Robin pairing system for tournaments as defined by CFC"""
